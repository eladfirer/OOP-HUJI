...
public final class ColorSupplier {
     ...
     *
     * @param baseColor  A color that we wish to approximate.
     * @param colorDelta The maximal difference (per channel) between the sampled color and the
     *                   base color.
     * @return A color similar to baseColor.
     */
    public static Color approximateMonoColor(Color baseColor, int colorDelta) {
        int channel = randomChannelInRange(baseColor.getRed() - colorDelta,
    ...
    public static Color approximateColor(Color baseColor, int colorDelta) {
        ...
        return new Color(
                randomChannelInRange(baseColor.getRed() - colorDelta,
                        baseColor.getRed() + colorDelta),
                randomChannelInRange(baseColor.getGreen() - colorDelta,
                        baseColor.getGreen() + colorDelta),
                randomChannelInRange(baseColor.getBlue() - colorDelta,
                        baseColor.getBlue() + colorDelta));
    }
